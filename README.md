...
#### docker run --link mysql:mysql -p 80:80 -p 2222:22 -p 9001:9001 -e USER=myusername -e PASSWORD=mypassword -e SHELLINABOX_PORT=9103 -p 9103:4200 -d orboan/dcsss-httpd-phpmyadmin
...
docker run --name mysql -d -p 3306:3306 -e MYSQL_ROOT_PASSWORD=whatever -e MYSQL_DATABASE1=phpmyadmin -e MYSQL_USER1=pma_user -e MYSQL_PASSWORD1=iaw orboan/dcsss-mariadb
...
`docker build --tag=orboan/dcsss-httpd-phpmyadmin .`
